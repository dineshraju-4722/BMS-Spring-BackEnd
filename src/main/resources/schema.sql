...
create table if not exists shows (date date,name varchar(20),language varchar(20),time time , movie int references movies(id) on delete cascade, theatre int references theatres(id) on delete cascade,primary key(date,time,theatre));