...
public class TheatreController {
	...
	@GetMapping("/theatresbylocation/{location}")
	public List<TheatresEntity> gettingtheatresbylocation(@PathVariable("location") String location){
		return theatreserv.getstheatresbylocation(location);
	}
